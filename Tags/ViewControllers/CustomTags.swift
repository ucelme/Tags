...
fileprivate extension Selector {
    static let onEditingChanged = #selector(CustomTags.editingChanged(_:))
}

class CustomTags: ScrollingContentViewController {
    ...
    func saveItems() {
      ...
      do {
        ...
        try data.write(to: dataSave(), options: Data.WritingOptions.atomic)
      } catch {
        print("Error encoding item array!")
      }
    }
...
extension CustomTags: HashtagViewDelegate {
...
extension CustomTags: UITextFieldDelegate {
